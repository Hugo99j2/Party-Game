 ...
 */
public final class GameModProvider implements GameProvider {
    ...
    public Collection<BuiltinMod> getBuiltinMods() {
        ...
        return List.of(
            new BuiltinMod(classPath, new GameMetadata(getNormalizedGameVersion()))
        );
    }
    ...
    public boolean locateGame(FabricLauncher fabricLauncher, String[] args) {
        ...
        var codeSource = GameModProvider.class.getProtectionDomain().getCodeSource();
        Path codePath;
        try {
        ...
        try {
            basePath = getLaunchDirectory()
                .resolve(Path.of("..", "core", "build", "libs", "core-1.0.0.jar"))
                .toRealPath();
        } catch(IOException e) {
