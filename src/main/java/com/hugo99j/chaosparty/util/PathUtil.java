...
public class PathUtil {
    ...
    public static String codingDir(String old) {
        if(Objects.equals(System.getenv("CODING_GAME"), "1")) {
            ...
            if(p.contains("Party-Game")) return MiscUtils.getTextBetween(p, "", "Party-Game")+"Party-Game/src/main/resources/"+old;
            if(p.contains("Chaos Party")) return MiscUtils.getTextBetween(p, "", "Chaos Party")+"Chaos Party/src/main/resources/"+old;
